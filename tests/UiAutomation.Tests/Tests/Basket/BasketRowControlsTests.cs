...
/// <summary>
/// Операции над уже добавленной строкой корзины: количество, выбор и удаление.
/// </summary>
/// <remarks>
/// Счётчик в строке и счётчик панели добавления — разные элементы: первый меняет
/// количество уже добавленной позиции, второй задаёт количество будущей. Здесь
/// проверяется только первый; панель добавления — в BASKET-004.
///
/// Сценарии собраны в одну фикстуру намеренно: каждая фикстура означала бы ещё
/// один вход на сайт, а сервер не выдерживал их подряд.
/// </remarks>
[TestFixture]
[NonParallelizable]
[Category("Basket")]
